    ...
    <main>
        ...
        <div class="como-coletar">
            ...
            <ol>
                ...
                <li><strong>Escolha o Tipo de Lixo:</strong> Na seção de agendamento, você encontrará uma lista de opções que representam os tipos de resíduos que você deseja que sejam coletados. Selecione a opção apropriada para o seu lixo. Por exemplo, você pode escolher entre "Móveis antigos", "Eletrônicos", "Resíduos Orgânicos" e assim por diante.</li>
